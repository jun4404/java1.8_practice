...
public class CustomFunctionalInterfaceExamples {
    ...
    public static void main(String[] args) {
        ...
        final InvalidFuntionalInterface anonymousClass = new InvalidFuntionalInterface() {
            @Override
        ...
        //System.out.println(invalidFuntionalInterface.mkString(123));
    }
